...
DICT["nav.attendance"] = { en: "Attendance", ar: "الحضور" };
DICT["page.attendance"] = { en: "Attendance", ar: "الحضور" };
DICT["att.subtitle"] = { en: "Staff attendance, leave, and payroll impact", ar: "حضور الموظفين والإجازات وأثر الرواتب" };
DICT["att.device_none"] = { en: "No biometric terminal connected yet — punches will appear here once it is set up.", ar: "لم يتم ربط جهاز بصمة بعد — ستظهر البصمات هنا بعد إعداده." };
DICT["att.device_online"] = { en: "terminal(s) online", ar: "جهاز متصل" };
DICT["att.kpi.active"] = { en: "Active staff", ar: "الموظفون النشطون" };
DICT["att.kpi.onshift"] = { en: "On shift now", ar: "في الدوام الآن" };
DICT["att.kpi.absences"] = { en: "Unjustified absences · month", ar: "غياب غير مبرر · الشهر" };
DICT["att.kpi.payroll"] = { en: "Net payroll · month", ar: "صافي الرواتب · الشهر" };
DICT["att.roster"] = { en: "Staff this month", ar: "الموظفون هذا الشهر" };
DICT["att.col.staff"] = { en: "Staff", ar: "الموظف" };
DICT["att.col.id"] = { en: "ID code", ar: "رقم الموظف" };
DICT["att.col.present"] = { en: "Present", ar: "حاضر" };
DICT["att.col.absent"] = { en: "Absent", ar: "غائب" };
DICT["att.col.sick"] = { en: "Sick", ar: "مرضي" };
DICT["att.col.salary"] = { en: "Salary", ar: "الراتب" };
DICT["att.col.net"] = { en: "Net pay", ar: "صافي الراتب" };
DICT["att.punches"] = { en: "Recent punches", ar: "أحدث البصمات" };
DICT["att.no_punches"] = { en: "No punches recorded yet.", ar: "لا توجد بصمات مسجلة بعد." };
DICT["att.leave"] = { en: "Pending leave requests", ar: "طلبات إجازة معلّقة" };
DICT["att.no_leave"] = { en: "No pending requests.", ar: "لا توجد طلبات معلّقة." };
DICT["att.payroll_title"] = { en: "Payroll → Fixed monthly", ar: "الرواتب ← المصاريف الثابتة" };
DICT["att.gross"] = { en: "Gross salaries", ar: "إجمالي الرواتب" };
DICT["att.deductions"] = { en: "Deductions (from attendance)", ar: "الخصومات (من الحضور)" };
DICT["att.netpay"] = { en: "Net payroll to pay", ar: "صافي الرواتب المستحق" };
DICT["att.fixed_monthly"] = { en: "Fixed monthly (incl. salaries)", ar: "المصاريف الثابتة (تشمل الرواتب)" };
DICT["att.payroll_hint"] = { en: "Edit salaries on the Staff page — they flow into Fixed monthly automatically.", ar: "عدّل الرواتب في صفحة الموظفين — تنعكس على المصاريف الثابتة تلقائياً." };
DICT["att.in"] = { en: "in", ar: "دخول" };
...
DICT["rep.kpi.absent"] = { en: "Absent days · month", ar: "أيام الغياب · الشهر" };
DICT["rep.kpi.warnings"] = { en: "Warning letters", ar: "الإنذارات" };
DICT["rep.kpi.incidents"] = { en: "Incident reports", ar: "البلاغات" };
DICT["rep.present"] = { en: "Present", ar: "حاضر" };
DICT["rep.absent"] = { en: "Absent", ar: "غائب" };
DICT["rep.records"] = { en: "Warnings & reports", ar: "الإنذارات والبلاغات" };
DICT["rep.add"] = { en: "Add a report", ar: "إضافة بلاغ" };
DICT["rep.kind"] = { en: "Type", ar: "النوع" };
DICT["rep.k.warning"] = { en: "Warning letter", ar: "إنذار" };
DICT["rep.k.incident"] = { en: "Incident (fight / theft…)", ar: "حادثة (شجار / سرقة…)" };
DICT["rep.k.note"] = { en: "Note", ar: "ملاحظة" };
DICT["rep.k.commendation"] = { en: "Commendation", ar: "تنويه" };
DICT["rep.titlefield"] = { en: "Title", ar: "العنوان" };
DICT["rep.detail"] = { en: "Details", ar: "التفاصيل" };
DICT["rep.severity"] = { en: "Severity", ar: "الخطورة" };
DICT["rep.sev.low"] = { en: "Low", ar: "منخفضة" };
DICT["rep.sev.medium"] = { en: "Medium", ar: "متوسطة" };
DICT["rep.sev.high"] = { en: "High", ar: "عالية" };
DICT["rep.when"] = { en: "Date", ar: "التاريخ" };
DICT["rep.save"] = { en: "Add", ar: "إضافة" };
DICT["rep.none"] = { en: "No reports yet for this person.", ar: "لا بلاغات لهذا الموظف بعد." };
DICT["rep.print"] = { en: "Print letter", ar: "طباعة خطاب" };
DICT["rep.delete"] = { en: "Delete", ar: "حذف" };
DICT["rep.months"] = { en: "By month", ar: "حسب الشهر" };
DICT["rep.month"] = { en: "Month", ar: "الشهر" };
DICT["rep.overview"] = { en: "Team overview", ar: "نظرة عامة على الفريق" };
DICT["rep.pick_hint"] = { en: "Select a staff member above to open their full report.", ar: "اختر موظفاً بالأعلى لفتح تقريره الكامل." };
DICT["rep.ack.pending"] = { en: "Awaiting acknowledgement", ar: "بانتظار الإقرار" };
DICT["rep.ack.done"] = { en: "Acknowledged", ar: "تم الإقرار" };
